  ...
  return (
    <div
      ...
      <Link
        ...
        <span className="w-14 h-14  relative  p-4 animate-spin-slow-reverse hover:text-accent group-hover:pouse">
          {icon ? getIcon(icon) : ""}
          <span className="absolute top-0 bottom-0 left-0 right-0 peer w-full h-full"/>
